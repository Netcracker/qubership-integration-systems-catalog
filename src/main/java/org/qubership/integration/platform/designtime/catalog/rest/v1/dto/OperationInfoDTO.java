...
@Data
@Builder
@Schema(description = "Operation info object")
public class OperationInfoDTO {
    @Schema(description = "Operation id")
    private String id;
    @Schema(description = "Specification part")
    private JsonNode specification;
    @Schema(description = "Request schemas for operation")
    private Map<String, JsonNode> requestSchema;
    @Schema(description = "Response schemas for operation")
